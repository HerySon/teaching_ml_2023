...
def split_ean13(df, drop_ean13=False):
    """
    This function split code column into 3 separate columns if it is digit and its length is 13.
...
df = pd.DataFrame({
    ...
    'code': ['1234567890123', '123456', '4567890123456', '', '0067890123456', '1234567890az3456']
    })
